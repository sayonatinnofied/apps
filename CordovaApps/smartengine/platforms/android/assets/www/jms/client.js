...
window.jms=(function(){
    ...
    var sender_queue="/queue/smartenginerequestnew";
    var receiver_queue="/queue/smartengineresponsenew";
    var username = "admin";
    ...
    function jmsRequest(requestType,message,callback){

        var reqType = requestType.toUpperCase();
        var correlationId = generateCorrelationId(reqType); //customerid + requesttype
