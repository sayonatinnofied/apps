...
//create user account
UserManagement.prototype.createUserAccount = function() {
...
//edit user account 
UserManagement.prototype.editUserAccount = function() {
    ...
    $(document).on("autocomplete",function(){
        autoCompleteUsername();
    });
    createEvent();
};
